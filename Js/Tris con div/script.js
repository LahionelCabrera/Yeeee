...
function faiMossa(indiceCella) {
    ...
    if(turnoDi === "X") {
        ...
        tutteLeCelle[indiceCella].style.backgroundColor = "black";
        tutteLeCelle[indiceCella].style.borderColor = "red";
    } else {
...
function() {
    ...
    for (let i = 0; i < tutteLeCelle.length; i++) {
        ...
        tutteLeCelle[i].style.backgroundColor = "white";
        tutteLeCelle[i].style.borderColor = "black";
    }
});
